# utf8proc is a dependency of arrow submodule
...
function(build_utf8proc)
  ...
  if(CMAKE_TOOLCHAIN_FILE)
    list(APPEND utf8proc_CMAKE_ARGS -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE})
  endif()
  ...
  set_target_properties(
    utf8proc::utf8proc
    PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${utf8proc_INCLUDE_DIR}"
