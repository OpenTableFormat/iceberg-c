function(extract_utf8proc_version)
  if(utf8proc_INCLUDE_DIR)
    ...
    string(
      REGEX MATCH
            "[0-9]+$"
            UTF8PROC_MAJOR_VERSION
            "${UTF8PROC_MAJOR_VERSION_DEFINITION}")
    string(
      REGEX MATCH
            "[0-9]+$"
            UTF8PROC_MINOR_VERSION
            "${UTF8PROC_MINOR_VERSION_DEFINITION}")
    string(
      REGEX MATCH
            "[0-9]+$"
...
if(utf8proc_FOUND)
  ...
  set_target_properties(utf8proc::utf8proc PROPERTIES IMPORTED_LOCATION "${utf8proc_LIB}" INTERFACE_INCLUDE_DIRECTORIES
                                                                                          "${utf8proc_INCLUDE_DIR}")
endif()
